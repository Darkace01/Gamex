...
namespace Gamex.Data.Migrations
{
    ...
    [Migration("20240508211824_Tournament_Rounds")]
    partial class Tournament_Rounds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gamex.Models.MatchUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Gamex.Models.RoundMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Gamex.Models.TournamentRound", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Gamex.Models.MatchUser", b =>
                {
                    b.HasOne("Gamex.Models.RoundMatch", "Match")
                        .WithMany("MatchUser")
            ...
            modelBuilder.Entity("Gamex.Models.RoundMatch", b =>
                {
                    b.HasOne("Gamex.Models.TournamentRound", "TournamentRound")
